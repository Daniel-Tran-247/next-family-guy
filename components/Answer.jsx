    ...
    <>
      <ul className='grid grid-cols-2 gap-2 md:grid-cols-4'>
        {answers.map(answer => {
          ...
          const isWrong = selected === answer && data && data?.correct !== selected
          ...
          return (
            <li key={answer}>
              ...
              className={cn('p-2 rounded-md items-center justify-between w-full flex text-sm font-semibold text-slate-200 disabled:cursor-not-allowed transition-all',
